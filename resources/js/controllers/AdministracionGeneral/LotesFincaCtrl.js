angular.module("LotesFincaCtrl", []).controller("LotesFincaCtrl", [
    ...
    function($scope, $rootScope, $http, $injector, $mdDialog) {
        ...
        Ctrl.getLaboresProductor = (lote, fechaInicial, fechaFinal) => {
            Ctrl.LotesLabores = [];
            $http.get ('/api/loteslaboresproductor/loteslaboresproductor/'+ lote + '/' + fechaInicial + '/' + fechaFinal , {}).then((r)=>{
        ...
        Ctrl.clickOnCard = (lote) => {
            ...
            if(lote.checked){
                ...
                Ctrl.getLaboresProductor(lote.id, Ctrl.semanas[Ctrl.indice].fechaInicial, Ctrl.semanas[Ctrl.indice].fechaFinal);          
            }
            /* 
