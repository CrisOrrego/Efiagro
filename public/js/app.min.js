    ...
    .controller('Articulos_ArticuloEditorCtrl', ['$scope', '$rootScope', '$http', '$injector', '$mdDialog', 'Articulo',
        function($scope, $rootScope, $http, $injector, $mdDialog, Articulo) {
            ...
            Ctrl.eliminarSeccion = (S) => {
                Rs.confirmDelete({
                    ...
                    Ctrl.SeccionesCRUD.delete(S)
                        .then(() => {
                            angular.forEach(Ctrl.SeccionesCRUD.rows, (S, iS) => {
                                if (S.indice != iS + 1) {
                                    S.indice = iS + 1;
                                    S.changed = true;
                                }
            ...
            Ctrl.moverSeccion = (S, n) => {
                ...
                // var elementoObjetivo = Ctrl.SeccionesCRUD.rows.find(function(seccion) {
                //     return seccion.indice = nuevoIndice;
                // });
                if (!elementoObjetivo)
                    return;
                ...
                // Ctrl.SeccionesCRUD.updateMultiple([S, elementoObjetivo]);
                S.changed = true;
